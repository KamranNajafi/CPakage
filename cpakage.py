...
DEFAULT_INSTALL_PATH = "local_repo/installed_packages"  # مسیر پیش‌فرض نصب بسته‌ها
...
def show_help_message():
    """نمایش دستورالعمل و توضیحات پیش‌فرض."""
    help_message = """
...
def main():
    print("cpakage is running!B")  # نمایش پیغام "cpakage is running!"
    ...
    # اگر هیچ آرگومانی وارد نشده باشد، دستورالعمل نمایش داده شود
    if not args.command:
        show_help_message()
        sys.exit(0)
